...
const Portfolio = () => {
  return (
    <section className="md:pt-48 sm:pt-28 pt-12 pb-8" id="portfolio" dir="rtl">
        ...
        <div className="grid lg:grid-cols-2 items-center gap-20">
          ...
          >
            ...
            <h2 className="text-white sm:text-40 text-30 mb-4 font-medium">
              نجمع بين التجربة المهنية والتحليل العلمي للسوق لنمنحك ميزة فريدة في{" "}
              <span className="text-primary">التداول</span>!
            </h2>
              ...
              <tbody>
                {portfolioData.map((item, index) => (
                  ...
                  >
                    ...
                    <td className="py-5">
                      <h4 className="text-muted sm:text-28 text-22 mr-5">
                        {item.title}
                      </h4>
                    </td>
                  </tr>
